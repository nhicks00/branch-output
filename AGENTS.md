...
| Area | Description |
|------|-------------|
| **Streaming** | Creates up to `MAX_SERVICES` (12) independent streaming outputs with dedicated services, encoders, and reconnect logic. |
...
- The plugin supports up to `MAX_SERVICES` (12) service slots.
